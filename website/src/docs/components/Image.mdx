...
<div className={'grid grid-cols-4 gap-3'}>
  ...
  <Image className={'w-auto rounded blur'} src={'https://www.huijiewei.com/images/05.jpg'} />
...
<div className={'grid grid-cols-4 gap-3'}>
  ...
  <Image
    className={'w-auto'}
    fallback={
      <div className={'border text-gray-400 border-gray-200 bg-gray-50 w-auto h-auto flex justify-center items-center'}>
        图片加载失败
      </div>
    }
    src={'https://www.huijiewei.com/images/012.jpg'}
