...
<div className={'flex flex-row gap-3'}>
  ...
  <Button className={'aspect-square !px-0'} variant={'outline'} color={'gray'}>
    <Github />
  </Button>
  <Button className={'aspect-square !px-0'} radius={'full'} color={'yellow'}>
    <Github />
  </Button>
  <Button className={'aspect-square !px-0'} variant={'light'} color={'red'}>
    <Sun />
  </Button>
  <Button className={'aspect-square !px-0'} variant={'subtle'} color={'green'}>
    <Moon />
  </Button>
</div>
```
...
<div className={'flex flex-row items-center gap-3'}>
  ...
  <ButtonGroup>
    <Button>保存</Button>
    <Button color={'gray'} className={'aspect-square !px-0'}>
      <Plus />
    </Button>
  </ButtonGroup>
  ...
  <ButtonGroup vertical>
    <Button>保存</Button>
    <Button color={'green'} className={'aspect-square !px-0'}>
      <Plus />
    </Button>
  </ButtonGroup>
