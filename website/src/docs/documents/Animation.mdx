...
function Demo() {
  ...
  return (
    <div className={'flex w-full h-96 items-center justify-center relative overflow-hidden'}>
      ...
      <button
        className={'absolute flex z-20 items-center justify-center top-1/2 left-3 bg-gray-100 w-10 h-10 rounded-full'}
        onClick={() => setPage([page + 1, 1])}
      >
        <ChevronRight className={'rotate-180'} />
      </button>
      <button
        className={'absolute flex z-20 items-center justify-center top-1/2 right-3 bg-gray-100 w-10 h-10 rounded-full'}
        onClick={() => setPage([page - 1, -1])}
      >
        <ChevronRight />
      </button>
