import { twClsx, VisuallyHidden } from '@agile-ui/react';
...
export const DefaultLayout = () => {
  return (
    <>
      <header className={'sticky top-0 z-40 w-full flex-none border-b border-slate-200 bg-white py-3 laptop:z-50'}>
